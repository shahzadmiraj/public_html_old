...
if( !function_exists( 'wcfm_delivery_time_display_format' ) ) {
	function wcfm_delivery_time_display_format( $vendor_id = 0 ) {
		...
		$time_format = apply_filters( 'wcfmd_delivery_time_display_format', $time_format, $vendor_id );
		return $time_format;
	}
}
...
if(!function_exists('get_wcfm_start_from_delivery_times_raw')) {
	function get_wcfm_start_from_delivery_times_raw() {
		return apply_filters( 'wcfm_start_from_delivery_time_options', 
					array( 
						0 => '10 minutes', 
						1 => '15 minutes', 
						2 => '30 minutes', 
...
if(!function_exists('get_wcfm_end_at_delivery_times')) {
	function get_wcfm_end_at_delivery_times() {
		return apply_filters( 'wcfm_end_at_delivery_time_options', 
					array( 
						0 => __( '30 minutes', 'wc-frontend-manager-delivery' ),
...
if(!function_exists('get_wcfm_slots_duration_delivery_times')) {
	function get_wcfm_slots_duration_delivery_times() {
		return apply_filters( 'wcfm_slots_duration_delivery_time_options', 
					array( 
						0 => __( '5 minutes', 'wc-frontend-manager-delivery' ), 
