...
<table class="wf-form-table">
    ...
    Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
        ...
        array(
            ...
            'help_text'=>sprintf(__('Select/add the additional order information in the invoice.%s Learn how to add order meta %s','print-invoices-packing-slip-labels-for-woocommerce'),'<a href="'.esc_url($order_meta_doc_url).'" target="_blank">', '</a>'),
        ),
        array(
            'type'=>"uploader",
